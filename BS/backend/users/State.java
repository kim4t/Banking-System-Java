...
/**
 * 
 * @author https://github.com/AustinC/UnitedStates/blob/master/src/main/java/unitedstates/US.java
 *
 */
public enum State {
    ...
    State(String unabbreviated, String ANSIabbreviation, String ISOabbreviation) {
